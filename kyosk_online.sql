...
CREATE TABLE IF NOT EXISTS `consumo` (
  ...
  CONSTRAINT `fk_consumo_comanda1` FOREIGN KEY (`COD_COMANDA`) REFERENCES `comanda` (`CODIGO`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `comanda` (
	...
	CONSTRAINT `omanda_FK` FOREIGN KEY (`COD_MESA`) REFERENCES `mesa` (`COD_MESA`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
